...
const styles = StyleSheet.create({
    ...
    tagText: { fontSize: 13, color: '#FFF', fontWeight: '700' },
    ...
    // Transport Section
    transportCard: { padding: 20, marginBottom: 24, backgroundColor: theme.colors.card.background },
    ...
    transportIconBox: { width: 40, height: 40, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.05)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', justifyContent: 'center', alignItems: 'center' },
    ...
    arrivalTipsBox: { borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.1)', paddingTop: 16 },
    ...
    modernSlotCard: { flex: 1, padding: 18, marginLeft: 20, flexDirection: 'row', gap: 16, backgroundColor: theme.colors.card.background },
    ...
    subActivityBox: { marginTop: 6, borderLeftWidth: 2, borderLeftColor: 'rgba(255,255,255,0.1)', paddingLeft: 10 },
    ...
    savedBtn: { backgroundColor: '#FF4E6A', shadowColor: 'rgba(255,78,106,0.3)' },
